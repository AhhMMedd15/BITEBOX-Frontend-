            ...
            <section className=" w-full h-[calc(100vh-80px)] bg-pastel">
                <form onSubmit={handleformsubmit}>
                    <div className="w-full h-full px-20 py-20">
                        <div className="w-full min-h-[50vh] border border-deep-teal bg-white shadow-2xl px-[100px] py-[10px] rounded-3xl ">
                            ...
                            <div className="w-full grid grid-cols-1 lg:grid-cols-4 mt-5 gap-5 text-deep-teal">
